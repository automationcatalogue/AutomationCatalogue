...
public class Constant {
    ...
    public static final String testId="TC_08_02";

    //General
    public static final int sno=0;
    public static final int sTestId=1;
    public static final int sTestName=2;

    //OrangeHRM
    public static final int sUserName_OrangeHRM = 3;
    public static final int sUserPassword_OrangeHRM = 4;

    //Add Employee
    public static final int sFirstName = 5;
    public static final int sLastName = 6;
    public static final int sLocation = 7;
    public static final int sDOB = 8;
    public static final int sRegion = 9;
    public static final int sFTE = 10;
    public static final int sTemporaryDepartment = 11;
    public static final int sEmployeeId_AddEmployee = 12;

    //Add User
    public static final int sEmployeeId_AddUser = 5;
    public static final int sAddUser_UserName = 6;
